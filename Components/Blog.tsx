...
//         <div>
//           <div className="w-[100%] relative h-[400px] rounded-full">
//             <Image
...
//                     mt-[-3rem] text-black font-semibold text-[17px] mx-auto"
//             >
//               December 15, 2022
//             </div>
...
//                     <p className="text-white">By Manjju Shree Devy Gendeti</p>
//                 </div>
//             </div>
//           </div>
//           <p className="mt-[1rem] text-white text-[18px] font-semibold">Polarized Extractive Summarization of Online Product Reviews @ MIKE Conference 2021</p>
//         </div>
//               </div>
//     </div>
//   );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 mt-[4rem] gap-[3rem] w-[70%] mx-auto">
        <div>
          ...
          <p className="mt-[1rem] text-white text-center text-[18px] font-semibold">
            <a  href="https://link.springer.com/chapter/10.1007/978-3-031-21517-9_15" target="_blank">Polarized Extractive Summarization of Online Product Reviews <span className="text-[#55e6a5]">@ MIKE Conference 2021</span></a>
