...
// const About = () => {
//   return (
//     <div className="bg-[#121121] pd-[3rem] pt-[4rem] md:pt-[8rem]">
...
//               delectus voluptate culpa et, quaerat, non laboriosam odio eaque
//               recusandae magnam natus itaque rem ratione modi! Similique
//               officiis adipisci beatae reiciendis?
//             </p>
//           </div>
//           <button
//             className="px-[2rem] hover:bg-yellow-300 transition-all duration-200 py-[1rem] text-[18px] 
